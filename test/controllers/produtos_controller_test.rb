...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { data_validade: @produto.data_validade, fornecedor_id: @produto.fornecedor_id, marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, qtd: @produto.qtd, tipo: @produto.tipo } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { data_validade: @produto.data_validade, fornecedor_id: @produto.fornecedor_id, marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, qtd: @produto.qtd, tipo: @produto.tipo } }
